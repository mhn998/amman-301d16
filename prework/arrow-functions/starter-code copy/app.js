...
// arrow functions don't have (this) keyowrd referring to themselves so its value keeps the same for all arrow functions their values will be equal to their closest parent normal function.